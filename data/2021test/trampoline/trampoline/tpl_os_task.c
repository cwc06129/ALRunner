...
StatusType ActivateTask(
    const TaskType task_id)
{
    return 0x1F & tpl_activate_task_service(task_id);
}
StatusType TerminateTask(void)
{
    return 0x1F & tpl_terminate_task_service();
}
StatusType ChainTask(
    const TaskType task_id)
{
    return 0x1F & tpl_chain_task_service(task_id);
}
StatusType Schedule(void)
{
    return 0x1F & tpl_schedule_service();
}
StatusType GetTaskID(
    TaskRefType task_id)
{
