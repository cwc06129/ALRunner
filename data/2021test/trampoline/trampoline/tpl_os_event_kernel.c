  ...
  const tpl_event_mask event)
{
  ...
  tpl_service.service_id = (14);
  tpl_service.parameters.id.task_id = (task_id);
  tpl_service.parameters.param.mask = (event);
  if ((result == (tpl_status)0) && (((task_id) >= (tpl_task_id)2) || ((task_id) < 0))) { result = (tpl_status)3; }
  if ((result == (tpl_status)0) && (tpl_stat_proc_table[task_id]->type != (tpl_proc_type)0x1)) { result = (tpl_status)1; }
  if ((result == (tpl_status)0) && (tpl_dyn_proc_table[task_id]->state == (tpl_proc_state)0x0)) { result = (tpl_status)7; }
  if ((result) == 0) {
  result = tpl_set_event(task_id, event);
  if (result == (tpl_status)((tpl_status)0 | (tpl_status)32))
  {
  ...
  const tpl_event_mask event)
{
  ...
  tpl_get_task_lock();
  if(((tpl_bool)0)!=tpl_get_interrupt_lock_status()) { result = 19; }
  tpl_service.service_id = (15);
  tpl_service.parameters.param.mask = (event);
  if ((result == (tpl_status)0) && (tpl_current_os_state() != (tpl_os_state)1)) { result = (tpl_status)2; }
  if ((result == (tpl_status)0) && (tpl_kern.running_id >= 1)) { result = (tpl_status)1; }
  if ((result) == 0) {
  ...
  tpl_event_mask * const event)
{
  ...
  tpl_get_task_lock();
  if(((tpl_bool)0)!=tpl_get_interrupt_lock_status()) { result = 19; }
  tpl_service.service_id = (16);
  tpl_service.parameters.id.task_id = (task_id);
  tpl_service.parameters.param.mask_ref = (event);
  if ((result == (tpl_status)0) && (((task_id) >= (tpl_task_id)2) || ((task_id) < 0))) { result = (tpl_status)3; }
  if ((result == (tpl_status)0) && (tpl_stat_proc_table[task_id]->type != (tpl_proc_type)0x1)) { result = (tpl_status)1; }
  if ((result == (tpl_status)0) && (tpl_dyn_proc_table[task_id]->state == (tpl_proc_state)0x0)) { result = (tpl_status)7; }
  if ((result) == 0) {
...
{
  tpl_status result = 0;
  tpl_task_events * task_events;
  tpl_get_task_lock();
  if(((tpl_bool)0)!=tpl_get_interrupt_lock_status()) { result = 19; }
  tpl_service.service_id = (17);
  tpl_service.parameters.param.mask = (event);
  if ((result == (tpl_status)0) && (tpl_current_os_state() != (tpl_os_state)1)) { result = (tpl_status)2; }
  if ((result == (tpl_status)0) && (tpl_kern.running_id >= 1)) { result = (tpl_status)1; }
