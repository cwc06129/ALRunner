...
def generate_assume_assert(s1_in_p, pred, s2_out_p, assumptions):
	...
	f.write("\n\
	// STATE / OUTPUT assume \n\
	__CPROVER_assume(prev_output.result >= 1 && prev_output.result <= 9); \n\
	")

	## Assume INPUT Define Section
	f.write("\n\
	// INPUT assume \n\
	__CPROVER_assume(prev_input.n1 >= 2 && prev_input.n1 <= 9); \n\
	__CPROVER_assume(input.n1 >= 2 && input.n1 <= 9); \n\
	__CPROVER_assume(prev_input.n2 >= 2 && prev_input.n2 <= 9); \n\
	__CPROVER_assume(input.n2 >= 2 && input.n2 <= 9); \n\
	")
	...
	{						\n\
		...
		// new input assume		\n\
		INPUT new_input;	\n\
		__CPROVER_assume(new_input.n1 >= 2 && new_input.n1 <= 9); \n\
		__CPROVER_assume(new_input.n2 >= 2 && new_input.n2 <= 9); \n\
		")
