...
extern tpl_resource * const
  tpl_resource_table[3];
extern tpl_resource res_sched_rez_desc;
tpl_status tpl_get_resource_service(
  const tpl_resource_id res_id);
tpl_status tpl_release_resource_service(
  const tpl_resource_id res);
...
StatusType WaitEvent(
    const EventMaskType event);
extern const char * const proc_name_table[2 + 0];
extern const tpl_tick OSTICKSPERBASE;
extern const tpl_tick OSMAXALLOWEDVALUE;
extern const tpl_tick OSMINCYCLE;
extern const tpl_tick OSTICKSPERBASE_counter100ms;
extern const tpl_tick OSMAXALLOWEDVALUE_counter100ms;
extern const tpl_tick OSMINCYCLE_counter100ms;
const EventMaskType evt1 = 1;
const ResourceType r1 = 0;
const ResourceType r2 = 1;
const TaskType t2 = 0;
const TaskType periodicTask = 1;
const AlarmType alarm1s = 0;
const AlarmType alarmevent = 1;
tpl_resource r1_rez_desc = {
                                          (tpl_priority)1,
                                          (tpl_priority)0,
                                          -1,
                                          ((void *)0)
};
tpl_resource r2_rez_desc = {
                                          (tpl_priority)2,
                                          (tpl_priority)0,
                                          -1,
                                          ((void *)0)
...
const tpl_tick OSMAXALLOWEDVALUE = 32767;
...
const tpl_tick OSTICKSPERBASE_counter100ms = 10;
const tpl_tick OSMAXALLOWEDVALUE_counter100ms = 10;
const tpl_tick OSMINCYCLE_counter100ms = 1;
tpl_counter counter100ms_counter_desc = {
                                10,
                                10,
                                1,
                                0,
...
{
  tpl_status need_rescheduling = 0;
    need_rescheduling |= tpl_counter_tick(&SystemCounter_counter_desc);
    need_rescheduling |= tpl_counter_tick(&counter100ms_counter_desc);
	/*extra*/  
	//need_rescheduling |= 32;
	/*extra*/  
  if (need_rescheduling == 32){
    tpl_schedule_from_running();
    if (tpl_kern.need_switch != 0x0) {
      tpl_switch_context_from_it(&(tpl_kern.s_old->context), &(tpl_kern.s_running->context)  );
    }
 }
}
tpl_stack_word periodicTask_stack_zone[32768/sizeof(tpl_stack_word)];
struct TPL_STACK periodicTask_stack = {periodicTask_stack_zone, 32768};
struct TPL_CONTEXT periodicTask_int_context;
void periodicTask_function(void);
const tpl_proc_static periodicTask_task_stat_desc = {
                                    &periodicTask_int_context,
                                    &periodicTask_stack,
                                    periodicTask_function,
                                    ((void *)0),
                                    1,
                                    1,
                                    5,
...
tpl_proc periodicTask_task_desc = {
                                          ((void *)0),
                                          0,
                                          (tpl_priority)1,
                                          0x0
};
tpl_stack_word t2_stack_zone[16000/sizeof(tpl_stack_word)];
struct TPL_STACK t2_stack = {t2_stack_zone, 16000};
struct TPL_CONTEXT t2_int_context;
void t2_function(void);
const tpl_proc_static t2_task_stat_desc = {
                                    &t2_int_context,
                                    &t2_stack,
                                    t2_function,
                                    ((void *)0),
...
tpl_proc t2_task_desc = {
                                          ((void *)0),
                                          0,
                                          (tpl_priority)2,
                                          0x0
};
tpl_task_events t2_task_evts = {
                   0,
                   0
};
...
tpl_alarm_static stat_alarm1s_alarm_desc = {
  {
                                        &counter100ms_counter_desc,
                                        tpl_raise_alarm
  },
                              (tpl_action *)&task_act_of_alarm1s
};
tpl_time_obj alarm1s_alarm_desc = {
                                        (tpl_time_obj_static *)&stat_alarm1s_alarm_desc,
                                        ((void *)0),
                                        ((void *)0),
                                        10,
                                        1,
...
tpl_alarm_static stat_alarmevent_alarm_desc = {
  {
                                        &counter100ms_counter_desc,
                                        tpl_raise_alarm
  },
                              (tpl_action *)&set_event_of_alarmevent
};
tpl_time_obj alarmevent_alarm_desc = {
                                      (tpl_time_obj_static *)&stat_alarmevent_alarm_desc,
                                      ((void *)0),
                                      ((void *)0),
                                      10,
                                      1,
...
tpl_time_obj * const
  tpl_alarm_table[2] = {
  &alarm1s_alarm_desc,
  &alarmevent_alarm_desc
};
tpl_proc_id tpl_priority_0_fifo[1];
tpl_proc_id tpl_priority_1_fifo[5];
...
const char * const proc_name_table[2 + 0] = {
  "t2",
  "periodicTask",
};