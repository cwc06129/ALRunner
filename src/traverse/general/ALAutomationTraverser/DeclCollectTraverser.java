...
//		if(f instanceof IfStatement) System.out.println("this is else statement : " + ((IfStatement)f).getEls());
		...
		if (f instanceof BranchStatement) { // for, do, if
			...
			getDeclStmtList().add((DeclarationStatement)f);
...
//	}
	...
	// 2023-03-24(Fri) SoheeJung
	// getter & setter
	public ArrayList<DeclarationStatement> getDeclStmtList() {
		return declStmtList;
	}

	public void setDeclStmtList(ArrayList<DeclarationStatement> declStmtList) {
		this.declStmtList = declStmtList;
	}
}
