...
void ecrobot_get_motor_speed();
void nxt_motor_get_count();
...
unsigned char ecrobot_get_sonar_sensor_return;
unsigned char ecrobot_set_motor_speed_port_id;
int ecrobot_set_motor_speed_speed;
unsigned char ecrobot_get_motor_speed_port_id;
unsigned char nxt_motor_set_count_port_id;
int nxt_motor_set_count_count;
unsigned char nxt_motor_get_count_port_id;
int nxt_motor_get_count_return;
...
void ecrobot_device_initialize() {
    ...
    ecrobot_init_sonar_sensor();
    nxt_motor_set_count_port_id = MOTOR_S;
