    ...
    tpl_alarm_base * info)
{
    ...
    tpl_service.service_id = (18);
    tpl_service.parameters.id.alarm_id = (alarm_id);
    tpl_service.parameters.param.alarm_base_ref = (info);
    if ((result == (tpl_status)0) && ((alarm_id) >= (tpl_alarm_id)2)) { result = (tpl_status)3; }
    if ((result) == 0) {
  ...
  tpl_tick * tick)
{
  ...
  tpl_get_task_lock();
  if(((tpl_bool)0)!=tpl_get_interrupt_lock_status()) { result = 19; }
  tpl_service.service_id = (19);
  tpl_service.parameters.id.alarm_id = (alarm_id);
  tpl_service.parameters.param.tick_ref = (tick);
  if ((result == (tpl_status)0) && ((alarm_id) >= (tpl_alarm_id)2)) { result = (tpl_status)3; }
  if ((result) == 0) {
    alarm = tpl_alarm_table[alarm_id];
    ...
    const tpl_tick cycle)
{
    ...
    tpl_get_task_lock();
    if(((tpl_bool)0)!=tpl_get_interrupt_lock_status()) { result = 19; }
    tpl_service.service_id = (20);
    tpl_service.parameters.id.alarm_id = (alarm_id);
    tpl_service.parameters.param.tick = (increment);
    tpl_service.parameters.param2.tick = (cycle);
    if ((result == (tpl_status)0) && ((alarm_id) >= (tpl_alarm_id)2)) { result = (tpl_status)3; }
    ...
    const tpl_tick cycle)
{
    ...
    tpl_get_task_lock();
    if(((tpl_bool)0)!=tpl_get_interrupt_lock_status()) { result = 19; }
    tpl_service.service_id = (21);
    tpl_service.parameters.id.alarm_id = (alarm_id);
    tpl_service.parameters.param.tick = (start);
    tpl_service.parameters.param2.tick = (cycle);
    if ((result == (tpl_status)0) && ((alarm_id) >= (tpl_alarm_id)2)) { result = (tpl_status)3; }
